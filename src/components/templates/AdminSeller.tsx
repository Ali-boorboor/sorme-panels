      ...
      <table className="w-4/5 overflow-scroll">
        ...
        <tbody className="">
          <tr className="border-t border-black text-left">
            ...
            <td className="font-semibold text-black text-xs md:text-lg py-2 relative after:absolute after:border-r-2 after:border-primary-color after:h-6 after:top-1/2 after:-translate-y-1/2 after:rotate-45 before:absolute before:border-r-2 before:border-primary-color before:h-6 before:top-1/2 before:-translate-y-1/2 before:-rotate-45 after:cursor-pointer before:cursor-pointer md:text-left text-center"></td>
          </tr>
          <tr className="border-t border-black text-left">
            <td className="font-semibold text-black text-xs md:text-lg py-2">Ali</td>
            <td className="font-semibold text-black text-xs md:text-lg py-2">2022/02/01</td>
